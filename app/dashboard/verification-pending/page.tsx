  ...
  return (
    <div className="max-w-lg space-y-6">
      <PageHeader
        ...
        description="Your account is pending approval from your cooperative owner."
      />

      <Alert>
        <AlertDescription>
          Your account is awaiting owner approval. You&apos;ll gain full access
          once a cooperative owner verifies your membership.
        </AlertDescription>
      </Alert>
      ...
      <p className="text-xs text-zinc-400 dark:text-zinc-600">
        ...
        and{" "}
        <a
          href="/dashboard/cooperative-details"
          className="underline hover:text-zinc-700 dark:hover:text-zinc-300"
        >
          cooperative details
        </a>{" "}
